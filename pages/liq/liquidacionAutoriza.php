...
<head>
    ...
    <title>AUTORIZA LIQUIDACION</title>
</head>
<body>
  <div>  <p>  </p></div>
  <div class="row"> 
    <div class="encabezado" title="Menu Principal"><strong>AUTORIZAION DE LIQUIDACIONES </strong></div>  
    <div><p>  </p></div>
        <div class="col-2">
        ...
        <div>
          <button  type="button" class="btn-default"><a href="/pages/liq/liquidacionAutorizaModificaFActuras.html">AUTORIZACION DE CHEQUE</a></button> 
