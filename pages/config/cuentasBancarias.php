...
<head>
    ...
    <title>CuentasB</title>
</head>
<body>
  <div>  <p>  </p></div>
  <div class="row"> 
    <div class="encabezado" title="Menu Principal"><strong>CUENTAS BANCARIAS </strong></div>  
    <div><p>  </p></div>
        ...
        <div class="col-2">
          <label for="disabledSelect" class="form-label">Nombre Banco:</label>
          <select id="disabledSelect" class="form-select">
          <option class="select">Seleciona empresa</option>
          <option>Banural</option>
          <option>G&T</option>
          </select>
        </div>
        ...
        <div class="col-2">
          <label for="disabledSelect" class="form-label">Nombre Chequera:</label>
        ...
        <div class="col-1">
          <label for="disabledSelect" class="form-label">Correlativo:</label>
          <input type="text" name="" id="">
        </div>
        ...
        <div>
          <button  type="button" class="btn-default"><a href="#">GUARDAR CHEQUERA</a></button> 
        </div>
      </div>
  ...
  <div>
    ...
    <thead>
      ...
      <th scope="col"><div class="mb-3"><label for="merc" class="form-label">Nombre Banco</label></div></th> 
      <th scope="col"><div class="mb-3"><label for="merc" class="form-label">Nombre Chequera</label></div></th>
      <th scope="col"><div class="mb-3"><label for="merc" class="form-label">Nombre de la cuenta</label></div></th>
      <th scope="col"><div class="mb-3"><label for="merc" class="form-label">Correlativa</label></div></th> 
